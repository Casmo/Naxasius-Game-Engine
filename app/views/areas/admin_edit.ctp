...
<?php
echo $form->create('Area', array('action' => 'edit', 'type' => 'file'));
?>
<fieldset>
...
<?php echo $form->input('Area.access', array('options' => array(0 => __('No', true), 1 => __('Yes', true)))); ?>
<?php echo $form->input('Area.restriction', array('options' => array('none' => __('None', true), 'up' => __('Up', true), 'right' => __('Right', true), 'left' => __('left', true), 'down' => __('Down', true)))); ?>
<?php echo $form->input('Area.travel_to', array('label' => 'Travel to area #', 'size' => 1)); ?>
<?php
echo $form->input('Area.travel_to_quest_id', array('options' => $quests, 'label' => 'Quest needed', 'empty' => array(0 => '')));
?>
<div class="text input">
<label>Background</label>
<?php echo $html->image('/img/game/tiles/'. $this->data['Tile']['image']) . '<br />'; ?>
</div>
</fieldset>
...
<fieldset>
<legend id="legendTiles"><?php __('Background tiles'); ?></legend>
<div id="tiles" style="display: none;"></div>
</fieldset>
<fieldset>
<legend id="legendMobs"><?php __('Mobs'); ?></legend>
<div id="mobs" style="display: none;">
</div>
</fieldset>
<fieldset>
<legend id="legendNpcs"><?php __('Npc\'s'); ?></legend>
<div id="npcs" style="display: none;">
</div>
</fieldset>
<fieldset>
<legend id="legendObstacles"><?php __('Obstacles'); ?></legend>
<div id="obstacles" style="display: none;"></div>
</fieldset>
<fieldset>
<legend id="legendSheets"><?php __('Sheets'); ?></legend>
