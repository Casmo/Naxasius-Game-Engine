...
<div class="c">
	...
	<div class="user_c">
		...
		<div class="characterinfo_c" id="characterinfo_c">
			...
			<div class="hp_bar_c" id="hp_bar_c" title="<?php __('Health'); ?>"><div class="hp_bar" id="hp_bar" style="width: <?php echo floor((100 / $gameInfo['Stat']['hp_max']) * $gameInfo['Stat']['hp']); ?>%;"></div><div class="hp_amount"><?php echo '<span id="char_hp">'. $gameInfo['Stat']['hp'] .'</span> / <span id="char_hp_max">'. $gameInfo['Stat']['hp_max'] .'</span>'; ?></div></div>
		</div>
	</div>
	...
	<div class="menu_c">
	<div class="menu_item"><?php echo $this->Html->link($this->Html->image('/img/game/interfaces/'. Configure::read('Game.interface') .'/icons/menu_home.png', array('title' => __('Home', true))), '/game', array('escape' => false)); ?></div>
	<div class="menu_item"><?php echo $this->Html->link($this->Html->image('/img/game/interfaces/'. Configure::read('Game.interface') .'/icons/menu_character.png', array('title' => __('Character info', true))), '#character', array('escape' => false, 'onclick' => 'showPopup(\''. $this->Html->url('/game/characters/view') .'\', \''. $this->Html->url('/img/game/avatars/'. $gameInfo['Avatar']['image_map'] .'/big-ingame.png') .'\')')); ?></div>
	<div class="menu_item"><?php echo $this->Html->link($this->Html->image('/img/game/interfaces/'. Configure::read('Game.interface') .'/icons/menu_quest.png', array('title' => __('Quests book', true))), '#quests', array('escape' => false, 'onclick' => 'showPopup(\''. $this->Html->url('/game/quests') .'\', \''. $this->Html->url('/img/game/interfaces/'. Configure::read('Game.interface') .'/icons/quest_book.png') .'\')')); ?></div>
	<div class="menu_item"><?php echo $this->Html->link($this->Html->image('/img/game/interfaces/'. Configure::read('Game.interface') .'/icons/menu_messages.png', array('title' => __('Messages', true))), '#messages', array('escape' => false, 'onclick' => 'showPopup(\''. $this->Html->url('/game/messages') .'\', \''. $this->Html->url('/img/game/interfaces/'. Configure::read('Game.interface') .'/icons/menu_messages.png') .'\')')); ?></div>
	<div class="menu_item"><?php echo $this->Html->link($this->Html->image('/img/game/interfaces/'. Configure::read('Game.interface') .'/icons/menu_ranking.png', array('title' => __('Rankings', true))), '#rankings', array('escape' => false, 'onclick' => 'showPopup(\''. $this->Html->url('/game/rankings') .'\')')); ?></div>
	<div class="menu_item"><?php echo $this->Html->link($this->Html->image('/img/game/interfaces/'. Configure::read('Game.interface') .'/icons/menu_logout.png', array('title' => __('Logout', true))), '/users/logout', array('escape' => false)); ?></div>
	</div>
	...
	<div class="karma_c borders" title="<?php __('Good/evil rating'); ?>"><div class="karma_bar" id="karma_bar" style="width: 50%;"></div><div class="karma_amount" id="karma_amount">50%</div></div>
