...
<rss version="2.0" xmlns:dc="http://purl.org/dc/elements/1.1/">
  <channel>
    ...
    <item>
      ...
      <link><?php echo $html->url('/news/view/'. $item['News']['id']); ?></link>
      <description><![CDATA[<?php if(!empty($item['News']['image'])) {
			echo $html->image('http://www.naxasius.com/img/website/news/'. $item['News']['image'], array('align' => 'left', 'title' => $item['News']['image_title']));
		}
		?><?php echo $item['News']['summary']; ?>]]></description>
       <pubDate><?php echo date('r', strtotime($item['News']['created'])); ?></pubDate>
      <guid><?php echo $html->url('/news/view/'. $item['News']['id']); ?></guid>
