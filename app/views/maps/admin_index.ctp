...
<table class="summary">
<tr>
<th class="center small"><?php echo $paginator->sort('#', 'Map.id'); ?></th>
<th class="medium"><?php echo $paginator->sort('Name', 'Map.name'); ?></th>
<th class="medium"><?php echo $paginator->sort('Subname', 'Map.subname'); ?></th>
<th><?php echo $paginator->sort('Battle type', 'Map.battle_system'); ?></th>
