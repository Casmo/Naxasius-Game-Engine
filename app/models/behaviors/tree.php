 ...
 */
	function children(&$Model, $id = null, $direct = false, $fields = null, $order = null, $limit = null, $page = 1, $recursive = null, $spacer = '_') {
		if (is_array($id)) {
			extract (array_merge(array('id' => null), $id));
		}
		...
		$results = $Model->find('all', compact('conditions', 'fields', 'order', 'limit', 'page', 'recursive'));
