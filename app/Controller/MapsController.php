	 ...
	 */
 	function admin_add() {
 		if(isset($this->data) && !empty($this->data)) {
 			if(!empty($this->request->data['Map']['name'])) {
 				$this->request->data['Map']['description'] = '';
 				$this->Map->bindModel(array('hasMany' => array('Area')));
 				$this->request->data['Area'][0]['x'] = 1;
 				$this->request->data['Area'][0]['y'] = 1;
 				$this->request->data['Area'][0]['tile_id'] = 1;
 				$this->request->data['Area'][0]['access'] = 1;
