 ...
 */
?>
<div class="action_actions"><?php echo $this->Html->image('/img/game/interfaces/'. Configure::read('Game.interface') .'/icons/attack_auto.png', array('title' => __('Auto attack'), 'onclick' => 'attack_mob(\''. $areasMob['AreasMob']['id'] .'\')')); ?></div>
<div class="action_actions"><?php echo $this->Html->image('/img/game/interfaces/'. Configure::read('Game.interface') .'/icons/eye.png', array('title' => __('Inspect mob'), 'onclick' => 'view_mob(\''. $areasMob['AreasMob']['id'] .'\')')); ?></div>
