...
<div class="icon"><?php echo $this->Html->image('/img/game/interfaces/'. Configure::read('Game.interface') .'/icons/attack_auto.png', array('title' => __('Auto attack'), 'style' => 'cursor: pointer;', 'onclick' => 'showPopup(\''. $this->Html->url('/game/areas_mobs/attack/'. $areasMob['AreasMob']['id']) .'\');')); ?></div>
</div>
