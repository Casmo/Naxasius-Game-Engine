...
<th class="medium"><?php echo __('Actions'); ?></th>
<th class="medium"><?php echo __('Conditions'); ?></th>
...
<tfoot>
<tr><td colspan="5">
<?php echo $this->Html->link($this->Html->image('/img/admin/icons/small/plus-button.png', array('alt' => 'add', 'class' => 'icon')). ' '. __('Add conversation', true), '/admin/conversations/add', array('escape' => false)); ?>
</td></tr>
</tfoot>
</table>
