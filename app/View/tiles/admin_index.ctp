...
<?php
echo $this->Form->create('Tile', array('action' => 'delete'));
?>
<h1>Tiles</h1>
<table class="summary">
<tr>
...
foreach($tiles as $tile) {
		...
		echo '<td class="center">'. $this->Html->link($this->Html->image('/img/game/tiles/'. $tile['Tile']['image']), '/admin/tiles/edit/'. $tile['Tile']['id'], array('escape' => false)) .'</td>';
		...
		echo '<td>';
		echo $tile['Tile']['doubles'] > 1 ? $this->Html->link($this->Html->image('/img/admin/icons/small/image-blur.png', array('onclick' => 'return confirm(\'Merge '. $tile['Tile']['doubles'] .' tiles?\')')), '/admin/tiles/merge/'. $tile['Tile']['id'], array('escape' => false)) .' ' : '';
		echo $this->Html->link($this->Html->image('/img/admin/icons/small/minus-button.png', array('onclick' => 'return confirm(\'Delete this tile?\')')), '/admin/tiles/delete/'. $tile['Tile']['id'], array('escape' => false));
		echo '</td>';
		echo '</tr>';
}
?>
...
<tfoot>
<tr><td colspan="6">
<?php echo $this->Html->link($this->Html->image('/img/admin/icons/small/plus-button.png', array('alt' => 'add', 'class' => 'icon')). ' Add', '/admin/tiles/add', array('escape' => false)); ?>
&nbsp;
<?php echo $this->Html->link($this->Html->image('/img/admin/icons/small/image-import.png', array('alt' => 'import', 'class' => 'icon')). ' Import', '/admin/tiles/import', array('escape' => false)); ?>
