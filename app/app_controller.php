...
class AppController extends Controller {
	var $helpers = array('Html', 'Form', 'Ubb');

	var $components = array('Auth', 'Session', 'RequestHandler', 'Interface');
 ...
 */
	function beforeRender() {
		if($this->RequestHandler->isAjax()) {
			$this->layout = 'ajax';
			$filePath = VIEWS . $this->viewPath . DS . 'ajax_' . $this->action . $this->ext;
